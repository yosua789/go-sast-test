...
func (r *EventTicketCategoryRepositoryImpl) Create(ctx context.Context, tx pgx.Tx, ticketCategory model.EventTicketCategory) (err error) {
	...
	query := `INSERT INTO event_ticket_categories (event_id, name, description, price, total_stock, total_public_stock, public_stock, total_compliment_stock, compliment_stock, color, code, entrance, created_at)
